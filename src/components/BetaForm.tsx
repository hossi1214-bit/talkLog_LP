...
export function BetaForm() {
  ...
  return <form className="beta-form" onSubmit={submit}>
    ...
    <fieldset><legend>使用端末 <em>必須</em></legend><div className="choice-grid">{["iPhone", "Android", "両方"].map((device) => <label key={device}><input type="radio" name="device" value={device} required /> {device}</label>)}</div></fieldset>
