...
export default function Home() {
  ...
  return <>
    ...
    <main>
      ...
      <section className="section beta" id="beta"><div className="container beta-grid"><div className="beta-copy"><div className="section-tag light">BETA TESTERS</div><h2>talkLogを、<br />一緒に育ててください。</h2><p>実際に使って、率直な感想を届けてくださるβテスターを募集しています。</p><ul><li>語学レベルは問いません</li><li>学習言語は問いません</li><li>外国語を話す練習をしたい方ならどなたでも</li></ul><div className="beta-mascot"><Image src="/images/log-kun-speaking.png" width={130} height={90} alt="話す練習を応援するログくん" /><span>あなたの声が、<br />より良いアプリにつながります。</span></div></div><BetaForm /></div></section>
